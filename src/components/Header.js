    ...
    return (
        <_Header className={`${active ? 'isActive' : ''}`}>
            <div className="header__container">
                ...
                <button type="button" className="menu__toggle" onClick={() => setActive(!active)} aria-label="Menu Button"></button>
            </div>
...
const _Header = styled.header`
    ...
    .menu {
        ...
        animation: 300ms linear 0s alternate forwards fadeout;
    ...
    &.isActive {
        .menu {
            animation: 300ms linear 0s alternate forwards fadein;
        }

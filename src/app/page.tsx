...
export default function HomePage() {
  return (
    <>
      ...
      <Typography variant="body" component="p">
        HipHop culture is my starting point, and I have experience with breakdancing, graffiti,
        DJing, and beatboxing. I have no experience in making HipHop music (yet!), so I would love
        to make HipHop music using sampling techniques, then drop the music one day.
      </Typography>

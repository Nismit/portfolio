export default class Slider {
    ...
    constructor(options = {}) {
        ...
        this.options = {
            ...
            // get parent element margin or padding
    ...
    setBoundaries() {
        if(window.innerWidth >= window.innerHeight) {
            this.offset = parseInt(window.getComputedStyle(this.options.element.parentElement).getPropertyValue('padding-left'), 10);

            // landscape
            this.boundaries = {
                max: -1 * this.options.element.clientWidth + (window.innerWidth - this.offset * 2),
                min: 0,
            ...
            this.offset = parseInt(window.getComputedStyle(this.options.element.parentElement).getPropertyValue('padding-top'), 10);
